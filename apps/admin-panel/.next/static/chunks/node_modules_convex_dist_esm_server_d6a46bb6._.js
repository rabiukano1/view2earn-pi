...
"[project]/node_modules/convex/dist/esm/server/impl/meta_impl.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getTransactionMetrics() {
    let syscallJSON;
    try {
        syscallJSON = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$server$2f$impl$2f$syscall$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["performAsyncSyscall"])("1.0/getTransactionMetrics", {});
    } catch (e) {
        var _e_message;
        if ((_e_message = e.message) === null || _e_message === void 0 ? void 0 : _e_message.includes("Unknown async operation")) {
            throw new Error("getTransactionMetrics() can only be called from a query or mutation. It is not available in actions or outside of a Convex function.");
        }
        throw e;
    }
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$values$2f$value$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsonToConvex"])(syscallJSON);
...
async function getFunctionMetadata() {
    const { name, componentPath } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$server$2f$impl$2f$syscall$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["performAsyncSyscall"])("1.0/getFunctionMetadata", {});
    return {
        name,
        componentPath
    };
...
async function getDeploymentMetadata() {
    const syscallJSON = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$server$2f$impl$2f$syscall$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["performAsyncSyscall"])("1.0/getDeploymentMetadata", {});
    const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$values$2f$value$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsonToConvex"])(syscallJSON);
    var _result_region;
    return {
        name: result.name,
        region: (_result_region = result.region) !== null && _result_region !== void 0 ? _result_region : null,
        class: result.class
    };
}
async function getRequestMetadata() {
    const { ip, userAgent, requestId, scheduledFunctionId } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$server$2f$impl$2f$syscall$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["performAsyncSyscall"])("1.0/getRequestMetadata", {});
    return {
        ip,
        userAgent,
        requestId,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$server$2f$impl$2f$syscall$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/convex/dist/esm/server/impl/syscall.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$server$2f$components$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/convex/dist/esm/server/components/paths.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$server$2f$impl$2f$meta_impl$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/convex/dist/esm/server/impl/meta_impl.js [app-client] (ecmascript)");
"use strict";
;
;
;
...
async function invokeMutation(func, argsStr, visibility) {
    ...
    const mutationCtx = {
        ...
        meta: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$server$2f$impl$2f$meta_impl$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setupMutationMeta"])(visibility),
        runQuery: (reference, args2, options)=>(options === null || options === void 0 ? void 0 : options.useStaleSnapshot) ? runUdf("snapshotQuery", reference, args2, options === null || options === void 0 ? void 0 : options.transactionLimits) : runUdf("query", reference, args2, options === null || options === void 0 ? void 0 : options.transactionLimits),
        runMutation: (reference, args2, options)=>runUdf("mutation", reference, args2, options === null || options === void 0 ? void 0 : options.transactionLimits)
    };
...
function strictReplacer(key, value) {
    if (value === void 0) {
        throw new Error('A validator is undefined for field "'.concat(key, '". This is often caused by circular imports. See https://docs.convex.dev/error#undefined-validator for details.'));
    }
    return value;
}
...
async function invokeQuery(func, argsStr, visibility) {
    ...
    const queryCtx = {
        ...
        meta: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$server$2f$impl$2f$meta_impl$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setupQueryMeta"])(visibility),
        runQuery: (reference, args2, options)=>{
            if (options === null || options === void 0 ? void 0 : options.useStaleSnapshot) {
                throw new Error("`useStaleSnapshot` is only supported in mutations, not queries.");
            }
            return runUdf("query", reference, args2, options === null || options === void 0 ? void 0 : options.transactionLimits);
        }
    };
...
async function invokeAction(func, requestId, argsStr, visibility) {
    ...
    const ctx = {
        ...
        meta: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$server$2f$impl$2f$meta_impl$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setupActionMeta"])(visibility)
    };
...
async function invokeHttpAction(func, request) {
    ...
    const ctx = {
        ...
        scheduler: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$server$2f$impl$2f$scheduler_impl$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setupActionScheduler"])(requestId),
        vectorSearch: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$server$2f$impl$2f$vector_search_impl$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setupActionVectorSearch"])(requestId),
        meta: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$server$2f$impl$2f$meta_impl$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setupActionMeta"])("public")
    };
    ...
    const handler = {
        get (_, prop) {
            ...
            if (!declared || !Object.prototype.hasOwnProperty.call(declared, prop)) {
                throw new Error('Env var "'.concat(prop, '" is not declared on ').concat(ownerLabel, ". Add it to the `env` option of ").concat(ownerLabel === "this app" ? "defineApp" : "defineComponent", "."));
            }
            return {
                __envVarRef: prop
            };
...
function use(definition, options) {
    ...
    var _options_name, _ref;
    const name = (_ref = (_options_name = options === null || options === void 0 ? void 0 : options.name) !== null && _options_name !== void 0 ? _options_name : // added recently
    importedComponentDefinition.defaultName) !== null && _ref !== void 0 ? _ref : // can be removed once backend is out
    importedComponentDefinition.componentDefinitionPath.split("/").pop();
    if (typeof name !== "string") {
        throw new Error("Component name must be a string. Received: ".concat(typeof name));
    }
    if (name.length === 0) {
        throw new Error("Component name cannot be empty.");
    }
    const httpPrefix = options === null || options === void 0 ? void 0 : options.httpPrefix;
    if (httpPrefix !== void 0) {
        if (!httpPrefix.startsWith("/")) {
            throw new Error('httpPrefix must start with "/". Received: "'.concat(httpPrefix, '"'));
        }
    }
    const envValues = {};
...
function exportAppForAnalysis() {
    ...
    const envVars = this._env ? Object.entries(this._env).map((param)=>{
...
function buildHttpMounts(childComponents) {
    ...
    for (const [name, , , httpPrefix] of childComponents){
        if (httpPrefix !== void 0) {
            ...
            httpMounts[normalized] = "_reference/childComponent/".concat(name);
        }
    }
    return httpMounts;
}
        ...
        if (p !== null) {
            ...
            for (const [name2, value] of Object.entries(p)){
                ...
                if (isEnvRef(value)) {
                    ...
                    throw new Error('Env var "'.concat(name2, '" must be a string or an env var reference. Received: ').concat(typeof value));
                }
            }
        }
...
function exportComponentForAnalysis() {
    const envVars = Object.entries(this._env).map((param)=>{
        let [name, validator] = param;
        return [
            name,
            {
...
function defineComponent(name, options) {
    ...
    if (options === null || options === void 0 ? void 0 : options.env) {
        for (const [key, decl] of Object.entries(options.env)){
            if (decl !== null && decl !== void 0 && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$values$2f$validator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isValidator"])(decl)) {
                envValidators[key] = decl;
            } else {
                throw new Error('Environment variable "'.concat(key, '" must be defined with a validator (e.g. v.string()).'));
            }
        }
    }
    const ret = {
        ...
        _exportTree: {},
        _onInitCallbacks: {},
        env: createEnvRefs('component "'.concat(name, '"'), options === null || options === void 0 ? void 0 : options.env),
...
function defineApp(options) {
    ...
    if (env !== void 0) {
        for (const [name, validator] of Object.entries(env)){
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$values$2f$validator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isValidator"])(validator)) {
                throw new Error('Environment variable "'.concat(name, '" must be defined with a validator (e.g. v.string()).'));
            }
        }
    }
    const ret = {
...
"[project]/node_modules/convex/dist/esm/server/logVars.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const vars = {
    /** Resolved to the request ID. */ requestId: REQUEST_ID,
    /** Resolved to the client's IP address. */ ip: IP,
    /** Resolved to the client's User-Agent header. */ userAgent: USER_AGENT,
    /**
...
"[project]/node_modules/convex/dist/esm/server/audit_logging.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/convex/dist/esm/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$server$2f$impl$2f$syscall$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/convex/dist/esm/server/impl/syscall.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$server$2f$logVars$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/convex/dist/esm/server/logVars.js [app-client] (ecmascript)");
"use strict";
;
;
;
function validateKey(key) {
    if (key.startsWith("$")) {
        throw new Error('Audit log body keys must not start with "$": "'.concat(key, '"'));
    }
}
function cloneValue(value) {
    if (typeof value === "symbol") {
        if (!(value in __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$server$2f$logVars$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["varNames"])) {
            throw new Error("Unknown audit var symbol: ".concat(String(value), "."));
        }
        return {
            $var: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$server$2f$logVars$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["varNames"][value]
        };
    }
...
const audit = async (body)=>{
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$server$2f$impl$2f$syscall$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["performAsyncSyscall"])("1.0/auditLog", {
        body: cloneWithSentinels(body),
        version: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["version"]
    });
}; //# sourceMappingURL=audit_logging.js.map
}),
"[project]/node_modules/convex/dist/esm/server/log.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$server$2f$audit_logging$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/convex/dist/esm/server/audit_logging.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$server$2f$logVars$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/convex/dist/esm/server/logVars.js [app-client] (ecmascript)");
"use strict";
;
;
const log = {
    audit: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$server$2f$audit_logging$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["audit"],
    vars: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$server$2f$logVars$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["vars"]
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$server$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/convex/dist/esm/server/log.js [app-client] (ecmascript)");
...
//# sourceMappingURL=node_modules_convex_dist_esm_server_d6a46bb6._.js.map