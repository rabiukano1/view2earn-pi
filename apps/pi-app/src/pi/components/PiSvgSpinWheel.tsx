...
export const TEN_WHEEL_PRIZES: WheelSectorPrize[] = [
  ...
  { pts: 0, label: "NO", sublabel: "BONUS", type: "zero", color: "#5B21B6", textColor: "#FFF" },
  ...
  { pts: 250, label: "250", sublabel: "PTS", type: "pts", color: "#8B5CF6", textColor: "#FFF" },
  { pts: 500, label: "500", sublabel: "PTS", type: "pts", color: "#5B21B6", textColor: "#FFF" },
