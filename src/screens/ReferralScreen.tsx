...
export default function ReferralScreen() {
  ...
  const share = () => {
    ...
    const link = `https://play.google.com/store/apps/details?id=com.view2earn&referrer=${referral.code}`;
    Share.share({
...
const styles = StyleSheet.create({
  ...
  copyBtnText: { color: colors.primaryDeep, fontWeight: '800', fontSize: 14 },
  shareBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'center',
