...
export const TEN_WHEEL_PRIZES: WheelSectorPrize[] = [
  ...
  { pts: -1, label: '+1', sublabel: 'SPIN', type: 'pts', color: '#5B21B6', textColor: '#FFF', icon: 'rotate-right' },
  ...
  { pts: -2, label: '+2', sublabel: 'SPINS', type: 'pts', color: '#8B5CF6', textColor: '#FFF', icon: 'rotate-right' },
  { pts: -3, label: '+3', sublabel: 'SPINS', type: 'pts', color: '#5B21B6', textColor: '#FFF', icon: 'rotate-right' },
